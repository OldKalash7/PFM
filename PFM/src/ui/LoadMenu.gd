...
func _on_save_pressed() -> void:
	print(save_list_control.get_item_text(save_list_control.get_selected_items()[0]))
	Main.EVENTS_LIST.emit_signal("load_game",save_list_control.get_item_text(save_list_control.get_selected_items()[0]))
